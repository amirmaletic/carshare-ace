...
const items: { kwartaal: string; status: Status; titel: string; beschrijving: string }[] = [
  ...
  { kwartaal: "Q3 2026", status: "now", titel: "Mobiele overdracht app", beschrijving: "Native gevoel op telefoon en tablet voor pick up en return, inclusief offline foto upload en signatuur." },
  { kwartaal: "Q3 2026", status: "now", titel: "Boekhouding koppeling Moneybird en e Boekhouden", beschrijving: "Push facturen automatisch naar je boekhoudsysteem met btw codes, grootboekrekeningen en relaties." },
  { kwartaal: "Q4 2026", status: "next", titel: "Klant identificatie via iDIN en NFC rijbewijs", beschrijving: "Snelle KYC bij online boeking met iDIN en NFC scan van het rijbewijs voor balieverhuur." },
  { kwartaal: "Q4 2026", status: "next", titel: "Whatsapp business kanaal", beschrijving: "Bevestigingen, overdrachten en herinneringen via Whatsapp, met tweerichtings antwoorden naar de planning." },
  { kwartaal: "Q1 2027", status: "next", titel: "Multi taal voor klantportaal", beschrijving: "Engels, Duits en Frans voor publieke boekingspagina, klantportaal en transactionele e mails." },
  { kwartaal: "Q1 2027", status: "later", titel: "Dynamische prijzen", beschrijving: "Automatisch je tarieven aanpassen op basis van bezetting, seizoen en lokale concurrentie." },
  { kwartaal: "Q2 2027", status: "later", titel: "Telematica integratie", beschrijving: "Live kilometerstand en locatie via OBD dongles en fabrieks API van Volkswagen, BMW en Tesla. Vereist hardware partnerschap en per merk certificering." },
  { kwartaal: "Q2 2027", status: "later", titel: "Marketplace voor verhuurders", beschrijving: "Optionele etalage waar klanten direct beschikbare voertuigen van aangesloten verhuurders kunnen boeken." },
  { kwartaal: "Q3 2027", status: "later", titel: "Schade afhandeling met verzekeraar koppeling", beschrijving: "Directe doorzet van schade dossiers met fotobewijs en taxatie naar verzekeraars en expertise bureaus." },
  { kwartaal: "Q3 2027", status: "later", titel: "AI dynamische routeplanning transport", beschrijving: "Optimale clustering van transportritten met meerdere voertuigen, chauffeurs en oplegger capaciteit op basis van levertijden." },
  { kwartaal: "Q4 2027", status: "later", titel: "Open API en webhooks v2", beschrijving: "Volledig publieke REST en webhook API met OAuth2, rate limiting en partner portaal voor third party integraties." },
  { kwartaal: "Q4 2027", status: "later", titel: "Wereldwijde uitrol en multi valuta", beschrijving: "Ondersteuning voor verschillende landen, btw regimes, talen en valuta voor internationaal opererende verhuurders." },
];
